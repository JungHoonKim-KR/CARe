...
> 영상 포트폴리오는 추후 업데이트 예정입니다.

---

**🖼️ 화면 설계서**

> 화면 설계서는 추후 업데이트 예정입니다.
...
> Jira 이슈 캡처는 추후 업데이트 예정입니다.

---

**📋 기능 명세서**

> 기능 명세서는 추후 업데이트 예정입니다.
...
자세한 환경 설정, 실행 방법, CI/CD 파이프라인은 [exec/빌드및배포문서.md](exec/빌드및배포문서.md)를 참고하세요.

---

**🔌 외부 서비스 설정**

Privy, Pinata, AWS S3, 스마트 컨트랙트 배포, APICK/NTS/GMS API 설정은 [exec/외부서비스설정.md](exec/외부서비스설정.md)를 참고하세요.

---

**🎬 시연 시나리오**

전체 시연 흐름은 [exec/시연 시나리오.md](exec/시연%20시나리오.md)를 참고하세요.
